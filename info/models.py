...
time_slots = (
    ...
    ('11:25 - 12:25', '11:25 - 12:25'),
    # ('12:25 - 12:45', '12:25 - 12:45'),
    ('12:45 - 01:45', '12:45 - 01:45'),
...
class Marks(models.Model):
    ...
    name = models.CharField(
        max_length=50, choices=test_name, default='Internals 1')
    ...
    def total_marks(self):
        if self.name == 'End Semester':
            return 80
        if self.name == 'Termwork':
            return 25
        if self.name == 'Viva':
            return 10
        if self.name == 'Practicals':
            return 15
        return 20
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Internals 1')
                    sc.marks_set.create(name='Internals 2')
                    sc.marks_set.create(name='Viva')
                    sc.marks_set.create(name='Practicals')
                    sc.marks_set.create(name='Termwork')
                    sc.marks_set.create(name='End Semester')
