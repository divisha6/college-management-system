...
def marks_list(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            sc.save()
            sc.marks_set.create(type='I', name='Internals 1')
            sc.marks_set.create(type='I', name='Internals 2')
            sc.marks_set.create(type='I', name='Viva')
            sc.marks_set.create(type='E', name='Practicals')
            sc.marks_set.create(type='E', name='Termwork')
            sc.marks_set.create(type='S', name='End Semester')
        sc_list.append(sc)
